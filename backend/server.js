...
const instructorRoutes = require('./routes/instructor'); // Import the instructor route
const app = express();
...
// Routes
app.use('/api/instructor',instructorRoutes); // This will use the instructor route when the path is '/api/instructor'
